...
impl Client {
    ...
    pub fn new() -> Self {
        ...
        headers.insert("X-Appwrite-Response-Format", "1.9.2".parse().unwrap());
        headers.insert("user-agent", format!("AppwriteRustSDK/0.4.0 ({}; {})", std::env::consts::OS, std::env::consts::ARCH).parse().unwrap());
        ...
        headers.insert("x-sdk-version", "0.4.0".parse().unwrap());
